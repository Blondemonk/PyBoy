...
class AbstractDQNAgent(Agent):
    """Write me
    """
    def __init__(self, nb_actions=None, memory=None, gamma=.99, batch_size=32, nb_steps_warmup=0,
...
class DQNAgent(AbstractDQNAgent):
    ...
    """
    def __init__(self, model=None, policy=None, test_policy=None, enable_double_dqn=False, enable_dueling_network=False,
